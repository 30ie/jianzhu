...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
  <tr> 
	 ...
	 <form id="addgroup" name="addgroup" method="post" action="" >
        ...
        <input id="groupname" name="groupname" type="text" class="input" value="<?php echo $strGroupAddName; ?>" size="22" onFocus="this.value=''" />
...
<input type="text" name="xuhao" style="width:32px" value="<?php echo $xuhao; ?>"  class="menuinput" />
<input type="text" name="menu"  value="<?php echo $menu; ?>" class="menuinput" style="width:110px" />
      <select name="target" >
	  ...
	  <select id="selcoltype_<?php echo $id; ?>" name="selcoltype" class="selcoltype">
	  <?php
	 ...
	 if($linktype=="1"){
	  ...
	  <div class="caozuo">
	  <input name="url" type="text" class="menuinput" id="url_selcoltype_<?php echo $id; ?>" value="<?php echo $url; ?>" size="22" style="display:none;margin-right:10px" />
	  <input name="folder" type="text" class="menuinput" id="folder_selcoltype_<?php echo $id; ?>" value="<?php echo $folder; ?>" size="22" style="display:none;margin-right:10px" />
...
<input type="text" name="xuhao" style="width:32px" value="<?php echo $subxuhao; ?>"  class="menuinput" />
<input type="text" name="menu"  value="<?php echo $submenu; ?>" class="menuinput" style="width:68px" />
      <select name="target" >
	  ...
	  <select id="selcoltype_<?php echo $subid; ?>" name="selcoltype" class="selcoltype">
	  <?php
	 ...
	 if($sublinktype=="1"){
	  ...
	  <div class="caozuo">
	  <input name="url" type="text" class="menuinput" id="url_selcoltype_<?php echo $subid; ?>" value="<?php echo $suburl; ?>" size="22" style="display:none;margin-right:10px" />
	  <input name="folder" type="text" class="menuinput" id="folder_selcoltype_<?php echo $subid; ?>" value="<?php echo $subfolder; ?>" size="22" style="display:none;margin-right:10px" />
