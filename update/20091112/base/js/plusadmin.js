...
$(document).ready(function() {
		...
		$("#admin_pageconset").append("<div class='pageconsetitem'>容器宽度：<select id='pagecontainwidth' ><option value='900'>默认(900PX)</option><option value='950'>门户(950PX)</option><option value='990'>宽幅(990PX)</option><option value='850'>中幅(850PX)</option><option value='780'>窄幅(780PX)</option><option value='720'>小窝(720PX)</option><option value='600'>名片(600PX)</option></select></div>");
